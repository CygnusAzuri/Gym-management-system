...
if(isset($_POST['task_desc'])){   
    ...
    $qry = "INSERT INTO todo(task_status, task_desc, user_id) VALUES (?, ?, ?)";
    $stmt = mysqli_prepare($con, $qry);
    mysqli_stmt_bind_param($stmt, "ssi", $task_status, $task_desc, $user_id);
        ...
        echo"<div class='container-fluid'>";
            ...
            echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                ...
                echo"<div class='widget-content'>";
                    ...
                    echo"<a class='btn btn-warning btn-big' href='to-do.php'>Go Back</a> </div>";
                echo"</div>";
                echo"</div>";
            echo"</div>";
            echo"</div>";
        ...
        echo"<div class='container-fluid'>";
            ...
            echo"<div class='widget-title'> <span class='icon'> <i class='icon-info-sign'></i> </span>";
                ...
                echo"<div class='widget-content'>";
                    ...
                    echo"<a class='btn btn-inverse btn-big' href='to-do.php'>Go Back</a> </div>";
                echo"</div>";
                echo"</div>";
            echo"</div>";
            echo"</div>";
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By sakumal</a> </div>
</div>
