                ...
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['services'] == 'Fitness') { echo '500';} elseif ($row['services'] == 'Sauna') { echo '700';} else {echo '600';} ?>' /></td>
                    </tr>
